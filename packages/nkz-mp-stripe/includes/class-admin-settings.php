...
final class Admin_Settings {
	...
	private function fields(): array {
		return [
			...
			[ 'type' => 'select', 'id' => 'nkv_svs__transfer_hook', 'title' => __( 'Kdy uvolnit výplatu prodejci', 'nkz-woo-stripe-vendor-split' ), 'desc' => __( 'Escrow = platforma drží peníze do podání zásilky + ochranná lhůta (nejbezpečnější).', 'nkz-woo-stripe-vendor-split' ), 'options' => [ 'escrow' => __( 'Escrow – po podání zásilky + ochranná lhůta (doporučeno)', 'nkz-woo-stripe-vendor-split' ), 'payment_complete' => __( 'hned po dokončení platby', 'nkz-woo-stripe-vendor-split' ), 'processing' => __( 'stav objednávky: zpracovává se', 'nkz-woo-stripe-vendor-split' ), 'completed' => __( 'stav objednávky: dokončeno', 'nkz-woo-stripe-vendor-split' ) ] ],
			[ 'type' => 'select', 'id' => 'nkv_svs__escrow_trigger', 'title' => __( 'Escrow – co spustí ochrannou lhůtu', 'nkz-woo-stripe-vendor-split' ), 'desc' => __( 'Podání zjišťujeme dotazem do Zásilkovny. „Tisk štítku" je nouzová varianta — vytištěná etiketa ale neznamená odeslaný balík.', 'nkz-woo-stripe-vendor-split' ), 'options' => [ 'dispatch' => __( 'skutečné podání zásilky (doporučeno)', 'nkz-woo-stripe-vendor-split' ), 'label' => __( 'vytvoření štítku', 'nkz-woo-stripe-vendor-split' ) ] ],
			[ 'type' => 'number', 'id' => 'nkv_svs__escrow_hold_days', 'title' => __( 'Escrow – ochranná lhůta (dní)', 'nkz-woo-stripe-vendor-split' ), 'desc' => __( 'Počet dní po podání zásilky, než se výplata uvolní. 0 = ihned po podání.', 'nkz-woo-stripe-vendor-split' ), 'custom_attributes' => [ 'step' => '1', 'min' => '0', 'max' => '60' ] ],
