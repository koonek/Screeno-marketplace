...
## Aktuální verze (bundle 0.22.7)

| Modul | Verze |
|---|---|
| nkz-marketplace (core) | 0.10.11-dev |
| nkz-mp-stripe (adapter, slug nkz-woo-stripe-vendor-split) | 0.6.9 |
| nkz-mp-storefront | 0.4.2 |
| nkz-mp-vendor-registration | 0.5.1 |
| nkz-mp-vendor-dashboard | 0.9.2 |
| nkz-mp-shipping | 0.1.0 |
| nkz-mp-vendor-billing | 0.5.2 |
| nkz-mp-packeta | 0.2.2 |
| **nkz-mp-aoz-bundle** | **0.22.7** |
