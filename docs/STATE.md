...
## Aktuální verze (bundle 0.25.0)

| Modul | Verze |
|---|---|
| nkz-marketplace (core) | 0.10.16-dev |
| nkz-mp-stripe (adapter, slug nkz-woo-stripe-vendor-split) | 0.7.0 |
| nkz-mp-storefront | 0.6.7 |
| nkz-mp-vendor-registration | 0.5.10 |
| nkz-mp-vendor-dashboard | 0.10.8 |
| nkz-mp-shipping | 0.2.0 |
| nkz-mp-vendor-billing | 0.5.2 |
| nkz-mp-packeta | 0.2.3 |
| **nkz-mp-aoz-bundle** | **0.25.0** |
